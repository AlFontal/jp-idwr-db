...
The examples intentionally omit static result tables. Surveillance releases are
updated regularly, so run each snippet against the version you intend to analyze
instead of relying on output copied from an older snapshot.
